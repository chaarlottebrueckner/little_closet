...
class OutfitFilterSheet extends StatefulWidget {
  ...
  final void Function(OutfitActiveFilters) onApply;
...
class _OutfitFilterSheetState extends State<OutfitFilterSheet> {
  ...
  void _apply() {
    final updated = OutfitActiveFilters()
              ...
              child: ListView(
                ...
                children: [
                  _buildSection(
                    ...
                    _styleTags,
                    (v) => setState(() => _styleTags.contains(v)
                        ? _styleTags.remove(v)
                        : _styleTags.add(v)),
                  ),
                  _buildSection(
                    ...
                    _seasons,
                    (v) => setState(() => _seasons.contains(v)
                        ? _seasons.remove(v)
                        : _seasons.add(v)),
                  ),
                  _buildSection(
                    'Wetter',
                    AppConstants.weatherTags,
                    _weatherTags,
                    (v) => setState(() => _weatherTags.contains(v)
